...
public class SearchOption implements Serializable {
    ...
    public SearchOption(boolean isHighlight) {
        this.highlight = isHighlight;
    }

    public SearchOption(SearchLogic searchLogic, boolean isHighlight) {
        this.searchLogic = searchLogic;
        this.highlight = isHighlight;
    }

    public SearchOption(SearchType searchType, SearchLogic searchLogic, String queryStringPrecision, DataFilter dataFilter, float boost, int highlight) {
