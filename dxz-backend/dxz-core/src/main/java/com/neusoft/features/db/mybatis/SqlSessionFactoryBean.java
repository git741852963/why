package com.neusoft.features.db.mybatis;
...
//    private Set<String> SettingsSet = new HashSet<>();
...
//            readXML(configLocation, elementTypeAlias, elementMapper, elementSettings);
        ...
        if (this.configLocations != null) {
            ...
            String value = "";
            try {
                Enumeration keys = configurationProperties.propertyNames();
                Class c = configuration.getClass();
                while (keys.hasMoreElements()) {
                    key = keys.nextElement();
                    value = configurationProperties.getProperty(key.toString());
                    ...
                    if ("boolean".equalsIgnoreCase(type)) {
                        ...
                        field.set(configuration, value.toString());
                    }else if ("java.lang.Integer".equalsIgnoreCase(type) || "int".equalsIgnoreCase(type)) {
                        field.set(configuration, Integer.valueOf(value));
                    } else {
                        //TOOD: 其他类型忽略
//                        throw new NotImplementedException();
                ...
                e.printStackTrace();
                logger.error("[MYSQL] configuration settings are illegal, key=" + key.toString() + " value=" + value + " message=" + e.getMessage());
            }
...
//        rootElement.addElement("settings");
    ...
    //TODO:读取没问题，但是没法经过DTD校验？
//    private void readXML(Resource configXML, final Element elementTypeAlias, final Element elementMapper, final Element elementSettings) {
